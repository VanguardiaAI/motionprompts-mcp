...
function powerOn() {
  ...
  gsap.to(renderer.domElement, { opacity: 1, duration: 0.5, ease: "{{motion.ease.primary}}" });
  gsap.to(monitorGroup.scale, { x: 1, y: 1, z: 1, duration: {{motion.duration.base}}, ease: "power3.out" });
}
