...
structural:
  ...
  - { kind: duration, literal: "20", rule: duration/loop }
  ...
  - { kind: ease, literal: "\"none\"", rule: value/narrated }
  - { kind: ease, literal: "\"back.out(1.75)\"", rule: ease/overshoot }
