...
structural:
  - { kind: duration, literal: "0.3", rule: value/simulation }
  ...
  - { kind: ease, literal: "\"elastic.out(1,0.5)\"", rule: ease/overshoot }
  - { kind: ease, literal: "\"power4.out\"", rule: value/narrated }
  - { kind: ease, literal: "\"elastic.out(1,0.75)\"", rule: ease/overshoot }
