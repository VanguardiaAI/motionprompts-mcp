...
structural:
  ...
  - { kind: ease, literal: "\"back.out(2)\"", rule: ease/overshoot }
  - { kind: ease, literal: "\"back.in(2)\"", rule: ease/overshoot }
...
sparkles.forEach((sparkle, index) => {
  ...
  timeline
    .fromTo(
      ...
      { scale: 1, rotate: 60, duration: {{motion.duration.base}}, ease: "back.out(2)" },
      popAt,
    )
    .to(
      sparkle,
      { scale: 0, rotate: 140, duration: {{motion.duration.base}}, ease: "back.in(2)" },
